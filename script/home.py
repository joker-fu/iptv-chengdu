...
homeLanAddress = "http://192.168.31.250:12123"
catchupBaseUrl = "http://192.168.31.250:12123"
...
def loadIcon():
    ...
    try:
        ...
        response = requests.get(sourceIcon51ZMT, verify=False, timeout=180)
...
def main():
    ...
    try:
        ...
        response = requests.get(sourceChengduMulticast, verify=False, timeout=180)
